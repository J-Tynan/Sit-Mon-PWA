...
This project is **not a news app** — it is a situational awareness console inspired by strategic
command‑center interfaces (e.g. Defcon). The goal is to consolidate signals — not stories — into a
